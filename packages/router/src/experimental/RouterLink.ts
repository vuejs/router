...
import { RouteRecordName } from '../typed-routes'

export interface RouterLinkOptions<
  Name extends keyof RouteMap = keyof RouteMap,
> {
  /**
   * Route name the link should navigate to when clicked on.
   */
  route: Name
...
> extends RouterLinkOptions<Name> {
  /**
  ...
  props: {
    ...
    ariaCurrentValue: {
      type: String as PropType<
        RouterLinkProps<keyof RouteMap>['ariaCurrentValue']
      >,
      default: 'page',
    },
    viewTransition: Boolean,
 ...
 * @internal
 */
type _RouterLinkPropsTypedBase<Name extends keyof RouteMap> =
  AllowedComponentProps &
    ComponentCustomProps &
    VNodeProps &
    RouterLinkProps<Name>

/**
 * @internal
 */
type RouterLinkPropsTyped<
  Name extends keyof RouteMap,
  Custom extends boolean | undefined,
> = Custom extends true
  ? _RouterLinkPropsTypedBase<Name> & { custom: true }
  : _RouterLinkPropsTypedBase<Name> & { custom?: false | undefined } & Omit<
...
export interface _RouterLinkI {
  new <
    Name extends keyof RouteMap,
    Custom extends boolean | undefined = boolean | undefined,
  >(
    props: RouterLinkPropsTyped<Name, Custom>
  ): {
    $props: typeof props
    ...
    $slots: {
      ...
      UnwrapRef<UseLinkReturn<Name>>) => VNode[]
    }
  }
