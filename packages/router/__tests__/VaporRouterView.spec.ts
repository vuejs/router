...
describe('RouterView', () => {
  ...
  async function factory(
    ...
    const app = createVaporApp(VaporRouterView, props)
    app._context.provides = route.provides
    app._context.components = { Routerview: VaporRouterView }
    app.mount('#app')
  ...
  it('displays nested views', async () => {
    ...
    expect(wrapper.html()).toMatchInlineSnapshot(
      `"<div>Nested<div>Foo</div><!--dynamic-component--><!--if--></div><!--dynamic-component-->"`
    )
  })
  ...
  //           components: { RouterView: VaporRouterView },
  //         },
  //       }
  //     )
  //     expect(wrapper.html()).toMatchSnapshot()
