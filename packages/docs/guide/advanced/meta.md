...
Sometimes, you might want to attach arbitrary information to routes like transition names, that can access the route, etc. This can be achieved through the `meta` property which accepts an object of properties and can be accessed on the route location and navigation guards. You can define `meta` properties like this:
